  ...
  assume_role_policy = <<POLICY
{
    ...
    "Statement": [
        ...
        },
        {
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::180294181827:root"
            },
            "Action": "sts:AssumeRole",
            "Condition": {
                "StringLike": {
                    "aws:PrincipalArn": [
                        "arn:aws:iam::180294181827:role/TerraformEngine/TerraformExecutionRole*",
                        "arn:aws:iam::180294181827:role/TerraformEngine/ServiceCatalogExternalParameterParserRole*",
                        "arn:aws:iam::180294181827:role/TerraformEngine/ServiceCatalogTerraformOSParameterParserRole*"
                    ]
                }
            }
        }
