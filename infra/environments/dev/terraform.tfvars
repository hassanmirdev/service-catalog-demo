products = {
  "EC2" = {
    ...
    template_url     = "https://servicecatalogterraform.s3.us-east-1.amazonaws.com/ec2-product.tar.gz"
  }
  "VPC" = {
    name             = "VPC"
    owner            = "Devops"
    ...
    support_url      = "https://wiki.example.com/IT/support"
    artifact_version = "v1.0"
    template_url     = "https://servicecatalogterraform.s3.us-east-1.amazonaws.com/vpc-product.tar.gz"
  }
}
